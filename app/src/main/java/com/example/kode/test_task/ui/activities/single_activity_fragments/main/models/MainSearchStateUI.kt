...
sealed class MainSearchStateUI : SearchResultStatesUI{
    ...
    class Position(private val position: String) : FilterableCreator<WorkerInfoEntity, WorkerInfoEntity> {

        override fun createFilterable(toSortList: List<WorkerInfoEntity>): SortUseCaseModel<WorkerInfoEntity> {
            return FilterableUseCaseModel(position, toSortList)
        }
    }
