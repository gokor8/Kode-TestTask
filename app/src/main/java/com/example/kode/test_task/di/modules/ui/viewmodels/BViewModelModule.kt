...
import com.example.kode.test_task.di.modules.ui.state_factories.StateFactoriesModule
...
@Module(includes = [BCommunicationModule::class, BUIMapperModule::class, BUseCaseModule::class, StateFactoriesModule::class])
